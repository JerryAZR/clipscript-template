...
- **"startAt references unknown line"** - typo or renamed id in subtitles.toml.
...
- **Cryptic smol-toml/zod error** - malformed subtitles.toml; the error path
