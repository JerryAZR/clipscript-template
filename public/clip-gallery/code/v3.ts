...
export const addUser = (user: User): void => {
  if (user.age < 0 || user.age > 150) { // !from if (user.age < 0) {
...
export const getUser = (name: string): User | undefined => { // !from export const findUser = (name: string): User | undefined => {
...
const listUsers = (): string[] => { // !from export const listUsers = (): string[] => {
